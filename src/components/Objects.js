...
const Objects = () => {
  ...
  return (
    <>
      <div className="text px-10 md:px-24 pt-20">
      {arrayOfAnObject.map((val, ind) => (
        <div className="text-lg my-10" key={ind}>
          <div className="font-semibold text-gray-700 font-serif"><span className="text-red-500 text-">{ind+1}</span>.  {val.question}</div>
          <span className=" text-lg font-thin mx-1"><span className=" font-bold"> A.</span> {val.A}</span>
          <span className=" text-lg font-thin mx-1"><span className="text font-bold"> B.</span> {val.B}</span>
          <span className=" text-lg font-thin mx-1"><span className="text font-bold"> C.</span> {val.C}</span>
          <span className=" text-lg font-thin mx-1"><span className="text font-bold"> D.</span> {val.D}</span>
        </div>
      ))}
    </div>
    </>
