...
const CBT = () => {
  ...
  return (
    <div className=' pt-18 overflow-hidden px-10 flex'>
            <div className="text w-2/3 h-screen bg-slate-400 p-20">
                  <div className="text absolute bottom-5 mx-auto flex w-2/3">
                        <button className="text-center font-bold w-1/3 ">Previous</button>
                        <button className="text-center font-bold w-1/3 " >Next</button>
                  </div>
                  <table className="text">
                        {arrayOfAnObject.map((val, index) => (
                              <tbody className="text">
                                    <tr className="text">{val.question}</tr>
                              </tbody>
                        ))}
                  </table>
            </div>
            <div className="text w-1/3 h-screen bg-slate-500"></div>
    </div>
  )
}
